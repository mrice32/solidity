...
#endif
#undef SOL_OPTIMIZE_ASM

#define SOL_OPTIMIZE_ASM 1
...
#ifdef SOL_OUTPUT_ASM
	cout << "Non-optimized asm: ------------------------------- " << endl << yul::AsmPrinter()(*parserResult) << endl;
#endif
...
#ifdef SOL_OPTIMIZE_ASM
	// TODO several optimizer steps cannot handle externally supplied local variables.
...
#ifdef SOL_OUTPUT_ASM
		cout << "Optimized asm: ------------------------------- " << endl << yul::AsmPrinter()(*parserResult) << endl;
#endif
