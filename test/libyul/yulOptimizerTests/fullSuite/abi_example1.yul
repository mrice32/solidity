...
//     let abi_encode_length := mload(_218)
...
//         revert(_2, _2)
//     }
//     let abi_decode_offset := calldataload(add(_221, 64))
//     let abi_decode := 0xffffffffffffffff
//     if gt(abi_decode_offset, abi_decode)
//     {
//         revert(_2, _2)
//     }
//     let abi_decode_value2 := abi_decode_t_array$_t_uint256_$dyn_memory_ptr(add(_221, abi_decode_offset), _220)
//     let abi_decode_offset_1 := calldataload(add(_221, 96))
//     if gt(abi_decode_offset_1, abi_decode)
//     {
//         revert(_2, _2)
//     }
//     let abi_decode_value3 := abi_decode_t_array$_t_array$_t_uint256_$2_memory_$dyn_memory_ptr(add(_221, abi_decode_offset_1), _220)
...
//         let _16 := 0x20
//         dst := add(array_5, _16)
//         let src := add(offset_3, _16)
//         if gt(add(add(offset_3, mul(length, 0x40)), _16), end_4)
//         {
//             revert(0, 0)
//         }
//         let i := 0
...
//             let abi_decode_1 := add(src, 0x40)
//             if gt(abi_decode_1, end_4)
//             {
//                 revert(0, 0)
//             }
//             let abi_decode_i := 0
...
//                 abi_decode_dst := add(abi_decode_dst, _16)
//                 abi_decode_src := add(abi_decode_src, _16)
//             }
...
//         }
//         let length_1 := calldataload(offset_27)
//         array_29 := allocateMemory(array_allocation_size_t_array$_t_address_$dyn_memory(length_1))
//         let dst_1 := array_29
//         mstore(array_29, length_1)
//         let _52 := 0x20
//         dst_1 := add(array_29, _52)
//         let src_1 := add(offset_27, _52)
//         if gt(add(add(offset_27, mul(length_1, _52)), _52), end_28)
//         {
//             revert(0, 0)
//         }
//         let i_1 := 0
