...
void CodeTransform::operator()(Block const& _block)
{
	...
	if (!m_stackErrors.empty())
		// TODO does this copy out of the vector?
		// Note tha later we migt copy from this exception and perhaps even into the vector...
...
int CodeTransform::variableHeightDiff(Scope::Variable const& _var, YulString _varName, bool _forSwap) const
{
	...
	if (heightDiff > limit)
		// throw exception with variable name and heigt diff
